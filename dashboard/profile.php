										...
										<div class="d-flex flex-stack flex-wrap align-items-end">
											...
											<div class="d-flex flex-column">
												...
												<div class="d-flex align-items-center mb-2">
													<a href="#" class="text-gray-800 text-hover-primary fs-2 fw-bolder me-1"><?php echo $_SESSION['fname'] . $_SESSION['lname'] ?></a>
												...
												<!--end::Name-->
												<!--begin::Text-->
												<span class="fw-bold text-gray-400 fs-6 mb-2 d-block"><?php echo $_SESSION['dob'] ?></span>
												<span class="fw-bold text-gray-600 fs-6 mb-2 d-block"><?php echo $_SESSION['bio'] ?></span>
