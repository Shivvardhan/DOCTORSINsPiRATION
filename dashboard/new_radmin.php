    ...
    <div id="kt_app_toolbar" class="app-toolbar py-3 py-lg-6">
        ...
        <div id="kt_app_toolbar_container" class="app-container container-fluid d-flex flex-stack">
            ...
            <div class="page-title d-flex flex-column justify-content-center flex-wrap me-3">
                <!--begin::Title-->
                <h1 class="page-heading d-flex text-dark fw-bold fs-3 flex-column justify-content-center my-0">Add Restaurent Admin</h1>
                <!--end::Title-->
                <!--begin::Breadcrumb-->
                        ...
                        <div class="card-body">
                            <div class="form">
                                ...
                                <div class="input-group input-group-solid mb-3">
                                    ...
                                    <div class="input-group input-group-solid mb-3">
                                        <input type="text" class="form-control" placeholder="User Type" aria-label="Username" readonly value="radmin" name="user_type" />
