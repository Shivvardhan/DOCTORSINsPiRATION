        ...
        <div id="kt_app_toolbar_container" class="app-container container-fluid d-flex flex-stack">
            ...
            <div class="page-title d-flex flex-column justify-content-center flex-wrap me-3">
                ...
                <ul class="breadcrumb breadcrumb-separatorless fw-semibold fs-7 my-0 pt-1">
                    ...
                    <li class="breadcrumb-item text-muted">Visa Status</li>
                </ul>
            </div>
        </div>
    </div>
                ...
                <table id="data-table" class="table table-bordered text-center align-middle">
                    <thead>
                        <tr>
                            ...
                            <th scope="col">Date of Visa Acceptance</th>
            ...
            <div class="modal-content">
                <form id="editStatusForm">
                    <div class="modal-header">
                        <h5 class="modal-title" id="editStatusModalLabel">Visa Status</h5>
                    ...
                    <div class="modal-body">
                        ...
                        <!-- Date of Visa Acceptance Field -->
                        <div class="mb-3">
                            <label for="dateOfVisaAcceptance" class="form-label">Date of Visa Acceptance</label>
                            <input type="date" class="form-control" id="dateOfVisaAcceptance" name="dateOfVisaAcceptance" required>
                        </div>
    ...
    <script>
        $(document).ready(function() {
            var table = $('#data-table').DataTable({
                ...
                serverSide: true,
                ajax: {
                    url: './phpdata/visa_status_data.php',
                    type: 'POST'
                },
                columns: [{
                        data: 0
        ...
        function openEditModal(button) {
            ...
            var visaStatus = button.getAttribute('data-visa-status');
            var visaDate = button.getAttribute('data-visa-date');
            ...
            document.getElementById('visaStatus').value = visaStatus;

            // Convert date to YYYY-MM-DD format if not empty
            if (visaDate && visaDate !== 'XX/XX/XXXX') {
                // Convert date from format DD-MM-YYYY to YYYY-MM-DD
                var dateParts = visaDate.split('-');
                if (dateParts.length === 3) {
                    var formattedDate = `${dateParts[2]}-${dateParts[1]}-${dateParts[0]}`;
                    document.getElementById('dateOfVisaAcceptance').value = formattedDate;
                } else {
                    document.getElementById('dateOfVisaAcceptance').value = ''; // Handle unexpected format
                }
            } else {
                document.getElementById('dateOfVisaAcceptance').value = ''; // Clear the field if no valid date is found
            }
        ...
        document.getElementById('editStatusForm').addEventListener('submit', function(e) {
            ...
            fetch('./phpdata/update_visa_status.php', {
                    method: 'POST',
                    body: formData
                })
