    ...
    <div id="kt_app_content_container" class="app-container container-fluid">
        <div class="row g-3 mb-3">
            ...
            <div class="col-md-12 col-lg-12 d-flex justify-content-between mt-4 p-4">
                <button type="button" id="deleteBtn" class="btn d-flex align-items-center justify-content-center" style="width: 48%; background-color: #166572; color: white; border: none; padding: 10px;">
                    <i class="fa-solid fa-trash me-2" style="font-size: 16px; color:white;"></i> Delete
                </button>
                <button type="button" id="updateBtn" class="btn d-flex align-items-center justify-content-center" style="width: 48%; background-color: #166572; color: white; border: none; padding: 10px;">
