            ...
            ?>
                <div class="row g-3 g-xl-10 mb-3 mb-xl-3">
                    ...
                    <div class="col-md-8 col-lg-6 col-xl-6 col-xxl-6 mb-md-6 mb-xl-3">
                        <div style="background-color:#FFF4DE;" class=" border border-gray-300 border-dashed rounded info min-w-125px py-10 px-4 me-6 mb-3">
                            <!--begin::Label-->
                    ...
                    <div class="col-md-8 col-lg-6 col-xl-6 col-xxl-6 mb-md-6 mb-xl-3">
                        <div style="background-color:#AEAFF7;" class=" border border-gray-300 border-dashed info rounded min-w-125px py-10 px-4 me-6 mb-3">
                            <!--begin::Label-->
                            <div class="row" style="align-items:center;">
                                <div class="col-3">
                                    <div class="icon-container">
                    ...
                    <div class="col-md-8 col-lg-6 col-xl-6 col-xxl-6 mb-md-6 mb-xl-3">
                        <div style="background-color:#FFF4DE;" class=" border border-gray-300 border-dashed info rounded min-w-125px py-10 px-4 me-6 mb-3">
                            <!--begin::Label-->
                            <div class="row" style="align-items:center;">
                                <div class="col-3">
                                    <div class="icon-container">
