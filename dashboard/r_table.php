...
<div id="kt_app_content" class="app-content flex-column-fluid">
        ...
        ?>
           ...
           if(isset($_POST['get'])){
            ...
            ?>
                ...
                <?php
            $sql1 = "SELECT * FROM r_table LEFT JOIN users ON r_table.uid = users.uid where r_name='$r_name'";
                ...
                <div id="kt_app_toolbar_container" class="app-container column container-fluid d-flex flex-stack">
                    <div class="card" style="width: 25rem;cursor: pointer;">
                        ...
                        <div class="card-body" style="text-align:center">
                            <h5 class="card-title"><?php echo $row["tablename"] ?></h5>
    ...
    <div class="row">
        ...
        <?php
                ...
                $sql = "SELECT * FROM `r_table` WHERE `uid`='$uid'";
                $result = $conn->query($sql);
            ...
            <div class="modal-content">
                ...
                <?php
                    ...
                    if (isset($_POST["submit"])) {
                        ...
                        $sql = "INSERT INTO r_table (uid , tablename , capacity)
        VALUES ('$username', '$tablename', '$capacity')";
